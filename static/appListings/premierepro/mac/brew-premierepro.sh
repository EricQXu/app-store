...
# 1.) Mount and install the Creative Cloud Installer pkg
# 2.) Mount and install the Premiere Pro standalone pkg
# You can get Premiere Pro standalone pkg by ripping it using https://github.com/chriswayg/CC-Offline-Package-Generator/blob/master/readme.md
cd /Applications
