...
# 2.) Mount and install the Photoshop standalone pkg
# You can get Photoshop standalone pkg by ripping it using https://github.com/chriswayg/CC-Offline-Package-Generator/blob/master/readme.md
cd /Applications
